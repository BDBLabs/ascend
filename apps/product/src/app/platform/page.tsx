...
export const metadata: Metadata = {
  title: 'Ascend — Storefront and Field for small trade contractors',
  description:
...
/**
 * The platform surface, served on the apex domain, app.useascend.com, and any
 * deployment hostname (the proxy rewrites those here). Public and tenant-free
 * by construction.
 *
 * Host-branched: field.useascend.com is the Field sign-in host and sends its
